  ...
  const [boardFormat, setBoard] = useState([
    ...
    },
    {
      ...
      inputs: [
        { label: "工事名", type: "text", maxRow: 8, maxCol: 1, value: "" },
        { label: "工種", type: "text", maxRow: 8, maxCol: 1, value: "" },
        { label: "側点", type: "text", maxRow: 8, maxCol: 4, value: "" },
      ],
      active: false,
    },
  ]);
